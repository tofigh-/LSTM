...
class FutureDecoder(nn.Module):
    def __init__(self,
        ...
        self.out_sale_means = nn.Sequential(
            nn.BatchNorm1d(self.hidden_size * 2 + NUM_COUNTRIES + 1, momentum=BN_MOMENTUM),
    ...
    def forward(self, input, hidden, embedded_inputs, encoder_outputs=None,
        ...
        out_sales_predictions = out_sales_mean_predictions + 0.5 * out_sales_variance_predictions
