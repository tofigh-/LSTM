...
class VanillaRNNModel(object):
    ...
    def __init__(self, embedding_descripts, load_saved_model=True, is_attention=True, model_path_dict=None,
        ...
        if is_attention:
            self.future_decoder = cuda_converter(FutureDecoderWithAttention(
                embedding_descripts,
                n_layers=1,
        ...
        self.future_decoder_optimizer = optim.SGD(self.future_decoder.parameters(), lr=LEARNING_RATE)
    ...
    def train(self, inputs, targets_future, loss_function, loss_function2, teacher_forcing_ratio,
        ...
        future_unknown_estimates = encoder_output = encoder_mask = None
    ...
    def encode_input(self, inputs):
        ...
        encoder_hidden, \
        embedded_features, \
        encoder_mask = self.encoder(input_seq, encoder_hidden)
    ...
    def decode_output(self,
        ...
        if hidden_state is None or future_unknown_estimates is None:
            ...
            embedded_features, \
            encoder_output, \
            encoder_mask = self.encode_input(inputs)
