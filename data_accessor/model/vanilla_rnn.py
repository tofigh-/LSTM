...
class VanillaRNNModel(object):
    ...
    def __init__(self, embedding_descripts, load_saved_model=True, is_attention=True, model_path_dict=None,
        ...
        self.encoder_optimizer = optim.Adagrad(self.encoder.parameters(), lr=LEARNING_RATE)
        self.future_decoder_optimizer = optim.Adagrad(self.future_decoder.parameters(), lr=LEARNING_RATE)
        if load_saved_model:
