...
POSITION_ENCODING = u'Position Encoding'
...
NUM_HEAD = 18
DROPOUT = 0.1
to_print_variables = ['TEACHER_FORCING_RATIO', 'OUTPUT_SIZE_FAR', 'FAR_WEEK_THRESHOLD', 'list_l2_loss_countries',
                      'list_l1_loss_countries', 'TEST_ZERO_SALE_PERCENTAGE',
...
FEATURE_DESCRIPTIONS = OrderedDict([
    ...
    (POSITION_ENCODING, {TYPE: DYNAMIC_GLOBAL, TRANSFORMATION: [ZERO_PAD], SIZE: 16}),
