...
### Feature Names
PAST_MEAN_SALE = u"Past Mean Sale"
...
ZERO_PAD = u"Zero Pad"
LOG_MOVING_AVG = u"Log Moving Average"
LOG_MEAN_REDUCER = u"Log Mean Reducer"
...
FEATURE_DESCRIPTIONS = {
    ...
    SALES_MATRIX: {TYPE: DYNAMIC_INT, TRANSFORMATION: [LOG_MEAN_REDUCER, ZERO_PAD]},
    DISCOUNT_MATRIX: {TYPE: DYNAMIC_INT, TRANSFORMATION: [ZERO_PAD]},
    GLOBAL_SALE: {TYPE: DYNAMIC_GLOBAL, TRANSFORMATION: [LOG_MEAN_REDUCER, ZERO_PAD]},
    ...
    PAST_MEAN_SALE: {TYPE: DYNAMIC_INT, TRANSFORMATION: [LOG_MOVING_AVG, ZERO_PAD]}
}
